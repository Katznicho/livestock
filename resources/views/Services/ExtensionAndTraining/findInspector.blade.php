...
<body>
    <div class="main-page-wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
              <!--table-->
              <h4>List of Trained Breeds Inspectors</h4>
              <div>
                The following is a list of KLBO Aproved Inspectors. Farmers can get any help from the inspectors on Breeding and Inspection of their Livestock.
              </div>
                ...
                <div>New Trained Inspectors</div>
                <div class="table__ssection2">
